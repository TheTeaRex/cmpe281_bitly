...
var page = function( req, res, state ) {
    ...
    if (state == "has-url"){
        ...
        msg = msg +'Your Long URL: <a href=' + longurl + ' target="_blank">'+ longurl +'</a><br>';
    ...
    if (state == "no-url"){
        ...
        getShortInfo(shorturl, function(result){
            ...
            if (result.status == "not found"){
                ...
                msg += '<h3><p align="center">Here is some information about the provided URL:</p></h3>';
